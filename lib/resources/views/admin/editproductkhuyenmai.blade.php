	...
	<div class="row">
		<div class="col-xs-12 col-md-12 col-lg-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">Sửa sản phẩm khuyến mãi</div>
						...
						<div class="row" style="margin-bottom:40px">
							<div class="col-xs-8">
								...
								<div class="form-group" >
									...
									<input required type="number" name="price" class="form-control" value="{{$prodlist->prod_giakhuyenmai}}">
								</div>
								<div class="form-group" >
									<label>Giá khuyến mãi</label>
									<input required type="number" name="giakhuyenmai" class="form-control" value="{{$prodlist->prod_gia}}">
								</div>
