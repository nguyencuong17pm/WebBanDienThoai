...
<title>@yield('title') | Bảo Kiêm Shop</title>
...
<body>
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="{{asset('doimatkhau/'.Auth::user()->id)}}"><svg class="glyph stroked key "><use xlink:href="#stroked-key"/></svg> Đổi mật khẩu </a></li>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="{{asset('admin/bill')}}"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-notepad"></use></svg> Hóa đơn</a></li>
			<li><a href="{{asset('admin/khuyenmai')}}"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-tag"></use></svg> Khuyến mãi</a></li>
			<li><a href="{{asset('admin/slide')}}"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-landscape"></use></svg> Slide</a></li>
